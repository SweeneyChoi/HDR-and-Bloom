...
int main()
{
	...
	Shader shader("bloom_vShader.glsl", "bloom_fShader.glsl");
	Shader shaderLight("bloom_vShader.glsl", "light_box_fShader.glsl");
	Shader shaderBlur("blur_vShader.glsl", "blur_fShader.glsl");
	Shader shaderBloomFinal("bloom_final_vShader.glsl", "bloom_final_fShader.glsl");
